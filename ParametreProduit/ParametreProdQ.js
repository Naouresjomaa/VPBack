...
const getParameterbyCatSC = 'SELECT * FROM public."ParametreProduit" WHERE "Categorie" = $1 AND "SousCategorie" = $2';
const checkparameterBySC = 'SELECT p FROM public."ParametreProduit" p WHERE p."SousCategorie"=$1';  
module.exports = {
  getParametre,
  Addparametre,
  getparameterbyid,
