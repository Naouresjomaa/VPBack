...
const Addbrand =
  'INSERT INTO public."Brands" ("BrandName", "Categorie", "SousCategorie","DateAjout", "DateExpiration", "AffichafeAccueil","Image") VALUES ($1, $2, $3, $4, $5, $6,$7)';
...
const getbrandCat = 'SELECT "BrandName", "SousCategorie" FROM public."Brands" GROUP BY "BrandName";';
module.exports = {
  getbrands,
  Addbrand,
  NBRBrand,
