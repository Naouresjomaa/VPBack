...
const createPanier =
  'INSERT INTO public."Panier" ("Produit", "ProdDetails", "PrixUnitaire", "Quantite", "PrixTotale", "UserName", "Email") VALUES ($1, $2, $3, $4, $5, $6, $7)';
const UpdatePanier =
  'UPDATE public."Panier" SET "Produit" = $1, "ProdDetails" = $2,  "PrixUnitaire" = $3, "Quantite" = $4, "PrixTotale" = $5, "UserName" = $6, "Email" = $7 WHERE id = $8';
